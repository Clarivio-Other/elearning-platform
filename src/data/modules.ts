import { Module, Badge, Resource } from "@/types";
    ...
    resources: [
      {
        ...
        description: "Report annuale di Stanford sullo stato dell'AI: trend, investimenti, adozione globale e impatto sulla società.",
        type: "link",
        url: "https://aiindex.stanford.edu/report/",
        tags: ["report", "trend", "Stanford"],
      },
      {
        id: "m1-link-00",
        title: "Wikipedia — Intelligenza Artificiale Generativa",
        description: "Panoramica completa e aggiornata sulla storia, i fondamenti e le applicazioni dell'AI generativa.",
        type: "link",
        url: "https://it.wikipedia.org/wiki/Intelligenza_artificiale_generativa",
        tags: ["enciclopedia", "fondamenti", "storia"],
      },
      {
        id: "m1-link-1",
        title: "Attention Is All You Need (Paper originale)",
        description: "Il paper del 2017 di Vaswani et al. che ha introdotto l'architettura Transformer, alla base di tutti i modelli AI generativi moderni.",
        type: "link",
        url: "https://arxiv.org/abs/1706.03762",
        tags: ["transformer", "paper", "architettura"],
      },
      {
        id: "m1-link-2",
        title: "Google AI Essentials — Corso gratuito",
        description: "Corso introduttivo gratuito di Google su Coursera per comprendere i fondamenti dell'intelligenza artificiale.",
        type: "link",
        url: "https://www.coursera.org/learn/google-ai-essentials",
        tags: ["corso", "gratuito", "fondamenti"],
      },
      {
        id: "m1-link-3",
        title: "Generative AI for Everyone — Andrew Ng",
        description: "Corso divulgativo di Andrew Ng su come funziona l'AI generativa e come può essere applicata.",
        type: "link",
        url: "https://www.coursera.org/learn/generative-ai-for-everyone",
        tags: ["corso", "gratuito", "divulgativo"],
      },
      {
        id: "m1-video-1",
        title: "But what is a neural network? — 3Blue1Brown",
        description: "Video divulgativo eccellente che spiega visivamente come funzionano le reti neurali e il deep learning.",
        type: "video",
        url: "https://www.youtube.com/watch?v=aircAruvnKk",
        tags: ["video", "reti neurali", "divulgazione"],
      },
    ],
    content: `
...
- **Educazione**: tutoring personalizzato e creazione di materiali didattici
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    resources: [
      {
        id: "m2-link-0",
        title: "There's An AI For That — Directory Strumenti",
        description: "Il database più completo di strumenti AI: oltre 10.000 tool catalogati per categoria, con recensioni e confronti.",
        type: "link",
        url: "https://theresanaiforthat.com/",
        tags: ["directory", "strumenti", "catalogo"],
      },
      {
        id: "m2-tool-1",
        title: "ChatGPT — OpenAI",
        description: "Il chatbot AI più diffuso al mondo. Modelli GPT-4o con supporto multimodale, canvas, navigazione web e Code Interpreter.",
        type: "tool",
        url: "https://chat.openai.com/",
        tags: ["chatbot", "testo", "multimodale"],
      },
      {
        id: "m2-tool-2",
        title: "Claude — Anthropic",
        description: "Assistente AI con finestra di contesto lunga (200k+ token), artefatti interattivi e forte focus sulla sicurezza.",
        type: "tool",
        url: "https://claude.ai/",
        tags: ["chatbot", "documenti", "contesto lungo"],
      },
      {
        id: "m2-tool-3",
        title: "Midjourney — Generazione Immagini",
        description: "Strumento leader per la generazione di immagini artistiche e fotorealistiche da prompt testuali.",
        type: "tool",
        url: "https://www.midjourney.com/",
        tags: ["immagini", "arte", "fotorealismo"],
      },
      {
        id: "m2-tool-4",
        title: "ElevenLabs — Sintesi Vocale AI",
        description: "Leader nella sintesi vocale realistica: voice cloning, text-to-speech in 30+ lingue, doppiaggio automatico.",
        type: "tool",
        url: "https://elevenlabs.io/",
        tags: ["audio", "voce", "sintesi"],
      },
      {
        id: "m2-tool-5",
        title: "Perplexity — Ricerca AI",
        description: "Motore di ricerca conversazionale che sintetizza informazioni dal web con fonti citate.",
        type: "tool",
        url: "https://www.perplexity.ai/",
        tags: ["ricerca", "fonti", "web"],
      },
      {
        id: "m2-link-1",
        title: "Ollama — Modelli AI in locale",
        description: "Piattaforma per eseguire modelli open source (Llama, Mistral, Phi) sul proprio computer con privacy totale.",
        type: "link",
        url: "https://ollama.com/",
        tags: ["open source", "locale", "privacy"],
      },
      {
        id: "m2-video-1",
        title: "AI Tools Tier List 2024",
        description: "Video comparativo dei principali strumenti AI organizzati per categoria e casi d'uso.",
        type: "video",
        url: "https://www.youtube.com/results?search_query=AI+tools+tier+list+2024",
        tags: ["comparazione", "strumenti", "video"],
      },
    ],
    content: `
...
- **Qualità richiesta**: per uso professionale, testare più modelli sullo stesso compito
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    resources: [
      {
        id: "m3-link-0",
        title: "Learn Prompting — Corso Gratuito Open Source",
        description: "Corso open source completo sul prompt engineering: dalle basi alle tecniche avanzate, con esempi interattivi.",
        type: "link",
        url: "https://learnprompting.org/",
        tags: ["corso", "gratuito", "open source"],
      },
      {
        id: "m3-link-00",
        title: "Google — Guida Introduttiva al Prompting",
        description: "Guida ufficiale di Google ai fondamenti del prompt engineering con esempi pratici per Gemini.",
        type: "link",
        url: "https://ai.google.dev/gemini-api/docs/prompting-intro",
        tags: ["guida", "Google", "Gemini"],
      },
      {
        id: "m3-link-1",
        title: "Prompt Engineering for Developers — DeepLearning.AI",
        description: "Corso gratuito di Andrew Ng e Isa Fulford sulle best practice del prompt engineering per sviluppatori.",
        type: "link",
        url: "https://www.deeplearning.ai/short-courses/chatgpt-prompt-engineering-for-developers/",
        tags: ["corso", "gratuito", "sviluppatori"],
      },
      {
        id: "m3-link-2",
        title: "OpenAI — Best Practices per i Prompt",
        description: "Guida ufficiale di OpenAI con strategie e tattiche per ottenere risultati migliori dai modelli GPT.",
        type: "link",
        url: "https://platform.openai.com/docs/guides/prompt-engineering",
        tags: ["guida", "ufficiale", "OpenAI"],
      },
      {
        id: "m3-link-3",
        title: "Anthropic — Prompt Engineering Guide",
        description: "Documentazione ufficiale di Anthropic con tecniche avanzate di prompt engineering per Claude.",
        type: "link",
        url: "https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview",
        tags: ["guida", "ufficiale", "Anthropic"],
      },
    ],
    content: `
    ...
    resources: [
      {
        ...
        description: "Guida open source completa alle tecniche avanzate di prompting: CoT, ToT, ReAct, Self-Consistency e molto altro.",
        type: "link",
        url: "https://www.promptingguide.ai/",
        tags: ["guida", "open source", "tecniche avanzate"],
      },
      {
        id: "m4-link-00",
        title: "Microsoft — Prompt Engineering Techniques",
        description: "Documentazione ufficiale Microsoft sulle tecniche avanzate di prompt engineering per Azure OpenAI.",
        type: "link",
        url: "https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/advanced-prompt-engineering",
        tags: ["Microsoft", "Azure", "best practice"],
      },
      {
        id: "m4-video-1",
        title: "Advanced Prompt Engineering — Full Course",
        description: "Corso video gratuito sulle tecniche avanzate di prompting: Chain-of-Thought, Few-Shot, meta-prompting e framework.",
        type: "video",
        url: "https://www.youtube.com/results?search_query=advanced+prompt+engineering+course+2024",
        tags: ["video", "corso", "avanzato"],
      },
      {
        id: "m4-link-1",
        title: "Chain-of-Thought Prompting — Paper originale",
        description: "Paper di Wei et al. (2022) che ha introdotto la tecnica Chain-of-Thought per migliorare il ragionamento degli LLM.",
        type: "link",
        url: "https://arxiv.org/abs/2201.11903",
        tags: ["paper", "CoT", "ricerca"],
      },
      {
        id: "m4-link-2",
        title: "OpenAI — Custom GPTs",
        description: "Documentazione ufficiale per creare GPT personalizzati con istruzioni, conoscenza e azioni specifiche.",
        type: "link",
        url: "https://openai.com/index/introducing-gpts/",
        tags: ["GPT personalizzati", "custom", "OpenAI"],
      },
      {
        id: "m4-link-3",
        title: "Tree of Thoughts — Paper",
        description: "Paper di Yao et al. (2023) che ha introdotto il Tree-of-Thought prompting per problemi complessi.",
        type: "link",
        url: "https://arxiv.org/abs/2305.10601",
        tags: ["paper", "ToT", "ragionamento"],
      },
    ],
    content: `
...
Questa tecnica si chiama **"AI come consulente"** e permette di scoprire applicazioni che non avremmo considerato autonomamente.
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    resources: [
      {
        id: "m5-link-0",
        title: "HubSpot — Guida Gratuita al Content Marketing con AI",
        description: "Guide, template e risorse gratuite di HubSpot per creare contenuti efficaci con l'intelligenza artificiale.",
        type: "link",
        url: "https://blog.hubspot.com/marketing/ai-content-creation",
        tags: ["content marketing", "guida", "gratuito"],
      },
      {
        id: "m5-link-00",
        title: "Google Digital Garage — Fondamenti di Marketing Digitale",
        description: "Corso gratuito certificato Google sui fondamenti del marketing digitale, incluse strategie di contenuto.",
        type: "link",
        url: "https://learndigital.withgoogle.com/digitalgarage",
        tags: ["corso", "Google", "certificato"],
      },
      {
        id: "m5-tool-1",
        title: "Gamma — Presentazioni AI",
        description: "Strumento per creare presentazioni, documenti e pagine web automaticamente con l'intelligenza artificiale.",
        type: "tool",
        url: "https://gamma.app/",
        tags: ["presentazioni", "slide", "automazione"],
      },
      {
        id: "m5-tool-2",
        title: "Copy.ai — Copywriting Assistito",
        description: "Piattaforma di copywriting AI per generare testi marketing, email, post social e contenuti per il web.",
        type: "tool",
        url: "https://www.copy.ai/",
        tags: ["copywriting", "marketing", "automazione"],
      },
      {
        id: "m5-link-1",
        title: "Content Marketing Institute",
        description: "Risorse, guide e best practice per il content marketing moderno, con approfondimenti sull'uso dell'AI.",
        type: "link",
        url: "https://contentmarketinginstitute.com/",
        tags: ["content marketing", "guide", "best practice"],
      },
    ],
    content: `
...
> "Genera un README.md professionale per [PROGETTO]. Includi: badge, descrizione one-liner, features, demo GIF placeholder, installazione (npm/pip/etc), quick start, configurazione, contributing guidelines, license, contatti."
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    resources: [
      {
        id: "m6-link-0",
        title: "UNESCO — Raccomandazione sull'Etica dell'AI",
        description: "Il primo strumento normativo globale sull'etica dell'intelligenza artificiale, adottato da 193 paesi.",
        type: "link",
        url: "https://www.unesco.org/en/artificial-intelligence/recommendation-ethics",
        tags: ["etica", "UNESCO", "normativa globale"],
      },
      {
        id: "m6-link-00",
        title: "OECD AI Policy Observatory",
        description: "Osservatorio OCSE sulle politiche AI: principi, trend normativi e best practice da oltre 60 paesi.",
        type: "link",
        url: "https://oecd.ai/",
        tags: ["policy", "OCSE", "governance"],
      },
      {
        id: "m6-video-1",
        title: "AI Hallucinations Explained — IBM Technology",
        description: "Video esplicativo di IBM sulle allucinazioni AI: perché accadono, come riconoscerle e come mitigarle.",
        type: "video",
        url: "https://www.youtube.com/results?search_query=IBM+technology+AI+hallucinations+explained",
        tags: ["video", "allucinazioni", "IBM"],
      },
      {
        id: "m6-tool-1",
        title: "Perplexity — Ricerca con Fonti",
        description: "Motore di ricerca AI che cita le fonti: ideale per il fact-checking e la verifica di contenuti generati.",
        type: "tool",
        url: "https://www.perplexity.ai/",
        tags: ["fact-checking", "ricerca", "fonti"],
      },
      {
        id: "m6-tool-2",
        title: "Consensus — Ricerca Scientifica AI",
        description: "Motore di ricerca AI per articoli scientifici peer-reviewed con Consensus Meter sul grado di accordo.",
        type: "tool",
        url: "https://consensus.app/",
        tags: ["accademico", "peer-review", "scienza"],
      },
      {
        id: "m6-link-1",
        title: "EU AI Act — Testo ufficiale",
        description: "Testo integrale del Regolamento Europeo sull'Intelligenza Artificiale (EU AI Act) approvato nel 2024.",
        type: "link",
        url: "https://artificialintelligenceact.eu/",
        tags: ["normativa", "EU AI Act", "regolamento"],
      },
      {
        id: "m6-link-2",
        title: "CRAAP Test — Evaluating Information",
        description: "Guida alla strategia di verifica CRAAP: Currency, Relevance, Authority, Accuracy, Purpose.",
        type: "link",
        url: "https://library.csuchico.edu/help/source-or-information-good",
        tags: ["verifica", "CRAAP", "fonti"],
      },
    ],
    content: `
